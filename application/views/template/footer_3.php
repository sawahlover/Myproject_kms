				...
				<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
					<div class="kt-container  kt-container--fluid ">
						<div class="kt-footer__copyright kt-font-dark kt-font-bold">
							<?= date("Y") ?>&nbsp;&copy;&nbsp;<a href="#" class="kt-link kt-font-fhi">FHI360 - INDONESIA</a>
						</div>
						<div class="kt-footer__menu">
							<a href="#" class="kt-footer__menu-link kt-link"><small class='kt-font-success'>KMS Version 1.0</small></a>
						</div>
					</div>
				</div>
				<!-- end:: Footer -->
